...
import com.example.fitnessevent.ui.like.LikeFragment;
...
//        LikeFragment l = new LikeFragment();
//        Bundle bundle = new Bundle();
//        bundle.putString("id", getIntent().getStringExtra("id"));
//        l.setArguments(bundle);
//
////        System.out.println("aaaaaaaa:"+ getIntent().getStringExtra("id"));
//
////
//        FragmentManager manager = getSupportFragmentManager();
//        FragmentTransaction transaction = manager.beginTransaction();
//        transaction.replace(R.id.fragment, new LikeFragment());
//        transaction.commit();
//
